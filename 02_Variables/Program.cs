...
namespace _02_Variables
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("Alınan Ürün: Çilek - " + "Birim Fiyat: " + applePrice + "- Gramaj: " +
            //   strawberryGram + "- Toplam Tutar: " + strawberryTotalPrice);

            //Console.WriteLine("Alınan Ürün: Patates - " + "Birim Fiyat: " + applePrice + "- Gramaj: " +
            //   potatoGram + "- Toplam Tutar: " + potatoTotalPrice);

            //Console.WriteLine("Alınan Ürün: Domates - " + "Birim Fiyat: " + applePrice + "- Gramaj: " +
            //   tomatoGram + "- Toplam Tutar: " + tomatoTotalPrice);

            //double shoppingTotelPrice = appleTotalPrice + orangeTotalPrice + strawberryTotalPrice + potatoGram + tomatoPrice;
            //Console.WriteLine();
            //Console.WriteLine();

            //Console.WriteLine("Alışveriş Toplam Tutar : " + shoppingTotelPrice + "TL");
            ...
            //Console.WriteLine("---------------------------");
            //Console.WriteLine("Yolcu Kimlik No: " + passengerIdentityNumber + "- Yolcu Ad Soyad :" +
